...
message("_CAFFE_INSTALL_PREFIX: ${_CAFFE_INSTALL_PREFIX}")

if(TRUE)
  if(NOT OpenCV_FOUND)
    set(Caffe_OpenCV_CONFIG_PATH "${_CAFFE_INSTALL_PREFIX}/sdk/native/jni/abi-arm64-v8a")
