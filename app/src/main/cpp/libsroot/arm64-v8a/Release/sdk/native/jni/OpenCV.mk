...
OPENCV_MODULES:=highgui ml objdetect photo stitching video calib3d features2d flann videoio imgcodecs imgproc core
...
ifeq ($(OPENCV_LIB_TYPE),SHARED)
    OPENCV_LIBS:=highgui ml objdetect photo stitching video calib3d features2d flann videoio imgcodecs imgproc core
    OPENCV_LIB_TYPE:=STATIC
else
